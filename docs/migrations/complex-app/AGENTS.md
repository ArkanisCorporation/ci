...
- Use `wf-setup-dotnet.yml`, `wf-dotnet-format.yml`, `wf-dotnet-test.yml`, `wf-setup-node.yml`, `wf-node-lint.yml`, `wf-node-test.yml`, and `wf-node-build.yml` for verification lanes.
